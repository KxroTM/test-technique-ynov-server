...
//
// Chaque méthode reçoit l'identifiant de l'utilisateur authentifié et le
// transmet au repository, qui l'intègre à sa clause WHERE. Le service n'a
// donc aucune vérification d'appartenance à écrire lui-même : elle est
// structurellement garantie par la requête SQL.
